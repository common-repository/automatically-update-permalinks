...
Donate link:
Tags: permalink, permalinks, slug, url
...
2. Search for "Automatically Update Permalinks".
3. Click "Install Now".
...
= 1.0.4 =
* Fix: The plugin functionality was not working for posts created with the block editor (Gutenberg)

= 1.0.3 =
* Only disable permalinks for manual post updates (via ) to avoid conflicts with importing plugins etc.

= 1.0.2 =
* Change author, tested up, license
